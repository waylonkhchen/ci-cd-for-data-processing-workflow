...
export TEST='test'
# for dataflow, we may not need it for BQ only tasks
...
#--------- the line below wasn't in the original. maybe we'd need it, maybe not--------
# export REF_BUCKET_RPOD="${GCP_PROJECT_ID}-composer-ref-${PROD}"
#--------- the line above wasn't in the original. maybe we'd need it, maybe not--------
